		...
		_notifications.append(
			{
				...
				"notification_text": notification.notification_text or notification.message or "",
				...
				"route_name": (
					...
					else "Lead" if notification.reference_doctype == "CRM Lead"
					else None
				),
			}
		)
...
def get_hash(notification):
	...
	if notification.type == "Assignment" and notification.notification_type_doctype == "CRM Task":
		_hash = "#tasks"
		if notification.message and "has been removed by" in notification.message:
			_hash = ""
