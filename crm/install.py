...
def add_default_fields_layout(force=False):
	quick_entry_layouts = {
		"CRM Lead-Quick Entry": {
			"doctype": "CRM Lead",
            "layout": '[{"name": "person_section", "columns": [{"name": "column_5jrk", "fields": ["salutation", "email"]}, {"name": "column_5CPV", "fields": ["first_name", "mobile_no"]}, {"name": "column_gXOy", "fields": ["last_name", "gender"]}]}, {"name": "organization_section", "columns": [{"name": "column_GHfX", "fields": ["organization", "territory"]}, {"name": "column_hXjS", "fields": ["website", "annual_revenue"]}, {"name": "column_RDNA", "fields": ["no_of_employees", "industry"]}]}, {"name": "lead_section", "columns": [{"name": "column_EO1H", "fields": ["status"]}, {"name": "column_RWBe", "fields": ["lead_owner"]}]}, {"name": "description_section", "columns": [{"name": "column_DESC", "fields": ["description"]}]}, {"name": "extra_section", "columns": [{"name": "column_OBJ", "fields": ["objective"]}, {"name": "column_ASN", "fields": ["assign_to"]}]}]',
        },
		"CRM Deal-Quick Entry": {
			"doctype": "CRM Deal",
			"layout": '[{"name": "organization_section", "hidden": true, "editable": false, "columns": [{"name": "column_GpMP", "fields": ["organization"]}, {"name": "column_FPTn", "fields": []}]}, {"name": "organization_details_section", "label": "Client Name", "editable": false, "columns": [{"name": "column_S3tQ", "fields": ["organization_name", "territory"]}, {"name": "column_KqV1", "fields": ["website", "annual_revenue"]}, {"name": "column_1r67", "fields": ["no_of_employees", "industry"]}]}, {"name": "contact_section", "hidden": true, "editable": false, "columns": [{"name": "column_CeXr", "fields": ["contact"]}, {"name": "column_yHbk", "fields": []}]}, {"name": "contact_details_section", "label": "Client POC", "editable": false, "columns": [{"name": "column_ZTWr", "fields": ["salutation", "email"]}, {"name": "column_tabr", "fields": ["first_name", "mobile_no"]}, {"name": "column_Qjdx", "fields": ["last_name", "gender"]}]}, {"name": "training_details_section", "label": "Training Details", "columns": [{"name": "column_td1", "fields": ["deal_name", "technology", "delivery_type", "expected_close_date"]}, {"name": "column_td2", "fields": ["start_date", "duration", "delivery_date", "stage"]}, {"name": "column_td3", "fields": ["end_date"]}]}, {"name": "commercial_proposed_section", "label": "Commercial - Proposed Cost (Quoted)", "columns": [{"name": "column_pc1", "fields": ["proposed_trainer_commercial", "proposed_lab_cost", "proposed_certification_cost", "proposed_misc_expense"]}, {"name": "column_pc2", "fields": ["trainer_costing_type", "trainer_no_of_days", "trainer_no_of_hours", "lab_costing_type", "lab_no_of_days", "lab_no_of_hours", "lab_pax", "certification_pax"]}, {"name": "column_pc3", "fields": ["proposed_trainer_cost", "proposed_lab_total", "proposed_certification_total", "proposed_total_override", "proposed_total"]}]}, {"name": "commercial_landing_section", "label": "Commercial - Landing Cost (Expenses)", "columns": [{"name": "column_lc1", "fields": ["landing_trainer_commercial", "landing_lab_cost", "landing_certification_cost", "landing_misc_expense"]}, {"name": "column_lc2", "fields": ["landing_trainer_cost", "landing_lab_total", "landing_certification_total", "landing_total_override", "landing_total"]}]}, {"name": "commercial_gst_section", "label": "GST (Optional)", "columns": [{"name": "column_gst1", "fields": ["gst_type", "gst_percentage"]}, {"name": "column_gst2", "fields": ["proposed_total_with_gst", "landing_total_with_gst"]}]}, {"name": "trainer_details_section", "label": "Trainer Details", "columns": [{"name": "column_trn1", "fields": ["trainer", "trainer_name", "trainer_status"]}, {"name": "column_trn2", "fields": ["trainer_notes"]}]}, {"name": "team_section", "label": "Team", "columns": [{"name": "column_team1", "fields": ["sales_manager", "solution_managers"]}, {"name": "column_team2", "fields": ["training_engagement_manager"]}]}, {"name": "notes_section", "label": "Notes", "columns": [{"name": "column_notes1", "fields": ["notes"]}]}, {"name": "assign_section", "columns": [{"name": "column_assign1", "fields": ["assign_to"]}]}]',
		},
		"Contact-Quick Entry": {
			"doctype": "Contact",
	...
	data_fields_layouts = {
		...
		"CRM Deal-Data Fields": {
			"doctype": "CRM Deal",
			"layout": '[{"name": "overview_tab", "sections": [{"label": "Training Details", "name": "training_details_section", "opened": true, "columns": [{"name": "column_dfd1", "fields": ["deal_name", "technology", "delivery_type", "expected_close_date"]}, {"name": "column_dfd2", "fields": ["start_date", "duration", "delivery_date", "stage"]}, {"name": "column_dfd3", "fields": ["end_date"]}]}, {"label": "Commercial - Proposed Cost (Quoted)", "name": "commercial_proposed_section", "opened": true, "columns": [{"name": "column_dfp1", "fields": ["proposed_trainer_commercial", "proposed_lab_cost", "proposed_certification_cost", "proposed_misc_expense"]}, {"name": "column_dfp2", "fields": ["trainer_costing_type", "trainer_no_of_days", "trainer_no_of_hours", "lab_costing_type", "lab_no_of_days", "lab_no_of_hours", "lab_pax", "certification_pax"]}, {"name": "column_dfp3", "fields": ["proposed_trainer_cost", "proposed_lab_total", "proposed_certification_total", "proposed_total_override", "proposed_total"]}]}, {"label": "Commercial - Landing Cost (Expenses)", "name": "commercial_landing_section", "opened": true, "columns": [{"name": "column_dfl1", "fields": ["landing_trainer_commercial", "landing_lab_cost", "landing_certification_cost", "landing_misc_expense"]}, {"name": "column_dfl2", "fields": ["landing_trainer_cost", "landing_lab_total", "landing_certification_total", "landing_total_override", "landing_total"]}]}, {"label": "GST (Optional)", "name": "commercial_gst_section", "opened": true, "columns": [{"name": "column_dfg1", "fields": ["gst_type", "gst_percentage"]}, {"name": "column_dfg2", "fields": ["proposed_total_with_gst", "landing_total_with_gst"]}]}, {"label": "Financial Summary", "name": "financial_summary_section", "opened": true, "columns": [{"name": "column_dff1", "fields": ["gross_profit"]}, {"name": "column_dff2", "fields": ["gross_profit_pct"]}]}, {"label": "Trainer Details", "name": "trainer_details_section", "opened": true, "columns": [{"name": "column_dft1", "fields": ["trainer", "trainer_name", "trainer_status"]}, {"name": "column_dft2", "fields": ["trainer_notes"]}]}, {"label": "Team", "name": "team_section", "opened": true, "columns": [{"name": "column_dfte1", "fields": ["sales_manager", "solution_managers"]}, {"name": "column_dfte2", "fields": ["training_engagement_manager"]}]}, {"label": "Notes", "name": "notes_section", "opened": true, "columns": [{"name": "column_dfn1", "fields": ["notes"]}]}]}]',
		},
	}
